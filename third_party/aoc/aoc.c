...
#include "third_party/aoc/2022/task10.c"*/
#include "third_party/aoc/2022/task11.c"
...
int main()
{
    ...
    runTask("2022 Day 9: Rope Bridge", task9);
    runTask("2022 Day 10", task10);*/
    runTask("2022 Day 11", task11);
